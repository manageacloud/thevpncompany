...
<#if !is_dev>
    ...
    <a class="github-fork-ribbon right-bottom fixed h-xs" href="https://github.com/manageacloud/thevpncompany/" data-ribbon="Fork me on GitHub" title="Fork me on GitHub">Fork me on GitHub</a>
</body>
</html>
</#macro>
