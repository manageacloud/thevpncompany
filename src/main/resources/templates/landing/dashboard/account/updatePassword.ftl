    ...
    <section class="c-f section-dashboard section-top">
        <div class="c">
            <div class="r">
                <div class="c-l-12">
                    <form method="post"
                          action-xhr="/dashboard/account/password/xhr"
...
<#--                                Cancelling plan ... Thank you for waiting-->
<#--                            </div>-->
<#--                        </template>-->
<#--                    </div>-->
<#--                    <div submit-success>-->
<#--                        <template type="amp-mustache">-->
<#--                            Your plan has been successfully cancelled<br>-->
<#--                        </template>-->
<#--                    </div>-->
<#--                    <div submit-error>-->
<#--                        <template type="amp-mustache">-->
...
<#--                        <div class="c-l-12">-->
<#--                            <button type="submit" class="b b-d">Cancel Plan</button>-->
<#--                        </div>-->
<#--                    </div>-->
<#--                </div>-->
<#--            </div>-->
