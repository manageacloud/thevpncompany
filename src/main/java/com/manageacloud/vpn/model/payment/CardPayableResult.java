...
public class CardPayableResult extends PayableResult {

    private CardPayableResult() {}

    public CardPayableResult(Subscription subscription, User user, String code, String text, String txtid) {
