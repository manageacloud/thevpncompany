...
public class CustomerPayableResult extends PayableResult {

    private CustomerPayableResult() {}

    public CustomerPayableResult(Subscription subscription, User user, String code, String text, String txtid) {
